...
const addValues = (arr) => {
  // Solution code here...
  const returns = arr.reduce((pValue, cValue) => pValue+cValue,0);
  return returns;
...
const addPurchases = (arr) => {
  // Solution code here...
  let sum = arr.reduce((aCal, cValue) => {
    return aCal + cValue.purchasePrice
  }, 0)
  return (sum);
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return(arr.reduce((pValue, cValue, i) => {
    pValue + cValue
    return i+1
  }
  )
...
const returnNames = (arr) => {
  // Solution code here...
  const array = [];
  arr.reduce((pValue, cValue) =>{
    array.push(cValue.name)

  })
  array.unshift(starWarsData[0].name)
  return array;
};
