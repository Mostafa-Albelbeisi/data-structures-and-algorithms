...
const maxInArray = (arr) => {
  // Solution code here...
  let num = arr.reduce((fNum, cNum) => {
    return fNum > cNum ? fNum : cNum;
  })
  return num
};
...
const checkValues = (obj, value) => {
  // Solution code here...
  let values = Object.values(obj).includes(value)
  return values
};
...
const getHouses = (arr) => {
  ...
  arr.reduce((pValue, cValue) =>{
    houses.push(cValue.house)

  })
  houses.unshift(characters[0].house)
